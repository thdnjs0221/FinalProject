...
$(function(){
	...
	$('#testAutoInsert').on("click",function(){
      ...
      $("#title").val("테스트 태영건설 신입사원 모집"); //공고제목
      $("#tjobCode").val("15"); //상위 직업
      $("#jobCode").val("건축디자인"); //하위 직업
      $("#rcrtField").val("건축디자인"); //모집분야명
      $("#rcrtPerson").val("3"); //모집인원
      $("input:checkbox[name='rcrtCareer'][value='신입']").prop("checked", true);
      $("#rcrtCondition").val("디자인 자격증 우대"); 
      $("#edu_select").val("고등학교졸업이상"); 
      $("#rcrtLoc").val("대전 동구 대전로 387, 223"); 
      ...
      $("#start_date").val("2023-12-05");
      $("#end_date").val("2023-12-17");
      $("input:radio[name='rcrtRectype'][value='내일을jOB자']").prop("checked", true);
      $("#rprocSdate").val("2023-12-18");
      $("#rprocEdate").val("2023-12-19");
      $("#rcrtNm").val("김소원");
      $("#rcrtTel").val("01012341234");
