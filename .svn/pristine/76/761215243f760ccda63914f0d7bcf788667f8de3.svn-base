						...
						<div class="company_info">
							...
							<div class="box_title">
								<h1 class="tit_company" title="${cominfo.companyNm}">
									${cominfo.companyNm}<span class="txt_info">합격자 이력서</span>
								</h1>
								<p class="txt_job">${cominfo.industryNm}</p>
							</div>
							<div class="box_btns">
								<button type="button" id="likeComBtn"
									class="interested_corp ga_data_layer"
									csn="aHJWVUlMaXJQWVBCdjFRTUJTa1pIdz09" del_fl="n"
									aria-pressed="false" first_nudge="off"
						...
						<div id="sri_wrap">
							<div id="content">
								<div class="header_interview_review">
									<div class="inner">
										<h2 class="blind">합격 이력서, 공유해줘서 고마워요!</h2>
										<p class="txt_noti">
											합격의 A~Z까지 내일을 JOB자 면접후기에서 확인해보세요!<br> #경력 #자격증 #자기소개서
											#합격자 이력서
										</p>
								...
								<div class="wrap_interview_review">
									<div class="review_cont">
										<form name="search_form" autocomplete="off">
											...
											<div class="title_area" style="padding-top: 17px;">
												<h2 class="tit_review">지금까지 공유된 이력서</h2>
											...
											<div class="list_review" id="ResumeDetail">
													...
													<c:forEach items="${resumeList }" var="resume">
														<div class="box_review">
															<div class="view_title">
																<strong class="txt_company"> <a
																	href="<%=request.getContextPath() %>/users/comResumeDetail/${cominfo.companyId}/${resume.resumeNo}"
																	id="ResumeDetail">${resume.resumeTitle }</a>
																</strong> <span class="txt_date">${resume.resumeDate }</span>
									...
									<div class="review_notice">
										...
										<ul class="list_notice">
											<li>- 이력서 등록 안내<br> ▶ 검수 전에는 ‘내 공유글’에서 내용 수정이
												가능합니다.<br> ▶ 검수 후에는 내용 수정 및 삭제가 불가합니다.<br> ▶ 부합하지
												않는 글은(욕설/비방/광고성/반복적인 글/허위 사실/기타 취지에 어긋나는 글) 관리자에 의해 통보 없이
												삭제될 수 있습니다.
											</li>
										</ul>
									</div>
