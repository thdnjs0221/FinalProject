							    ...
							    <div class="company_top">
							        <div class="logo_box TipBox">
							            <button type="button" class="logo">
							                <span class="thumb"><img class="mainLogo" src="<%=request.getContextPath() %>/resources/images/mainLogo.png" alt="Logo"></span>
							            </button>
				       	...
				       	<div class="progresses progress">
						    <div class="title">
						        <strong>
						            ...
						            <a href="/zf_user/company/recruit-manage?mode=ing" class="more"><span class="count">2</span>
						            <span class="unit">건</span>전체보기</a>
						        </strong>
						    </div>
						</div>
