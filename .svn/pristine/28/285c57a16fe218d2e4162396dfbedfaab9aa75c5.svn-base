...
<div id="sri_section" class=" layout_full companyDetail">
	<div id="sri_wrap">
		<div id="content" class="cmpyDtlCnt">
        ...
        <symbol id="ico_partnership" fill="none" viewBox="0 0 24 16">
            ...
            <defs>
				...
				<div class="sidebar recommendation" style="border:none;">
					<div class="scroller">
					...
					<section class="section workplace_section">
						...
						<div class="section_content">
							...
							<div class="area_company_infos">
								...
								<div class="content_fold active mt-5">
									<dl class="company_details">
										...
										<div class="company_details_group">
											<dt class="tit">복리후생</dt>
											<dd class="desc">
												<p class="ellipsis" title="${cominfo.cominfoBenefit }">
													${cominfo.cominfoBenefit }
												</p>												
											</dd>
										</div>
									</dl>
