...
<div class="wrap_recruit_frm wrapRecruitFrm">
	<form:form action="${pageContext.request.contextPath}/recruit/new"
		modelAttribute="recruit" method="post">
		<!--     폼으로 보내야하니까 채용공고 번호 히든으로 바꾸기 -->
         <input type="hidden" swHidden name="rcrtKeywordnm" value="" />
								...
								<div class="InpBox SizeL">
									<select name="jobCode" id="jobCode">
										...
										<c:forEach items="${jobCodeList}" var="job">
											<option value="${job.jobNm}" id="${job.jobCode}"
									...
									<div class="items">
										...
										<div class="area_data">
											<div class="division_name" id="division_name_area_0"
												data-seq="0">
												<div class="TypoBox">
													<input type="text" id="rcrtField" value="${recruit.rcrtField}"
								...
								<div class="fulldata">
									<div class="items">
										...
										<div class="area_data">
											<span class="division_collect">
												<div class="TypoBox">
													<input type="text" id="rcrtPerson" name="rcrtPerson" value="${recruit.rcrtPerson}"
									...
									<div class="items">
										...
										<div class="area_data type_txt">
											...
											<div class="InpBox">
												<span class="Chk SizeL career_cd_sub_0_0"
													style="display: none"><input type="checkbox"
													class="freshman_can_apply" id="freshman_can_apply_0"
													value="신입 지원 가능" name="rcrtCareer"><label
													class="Lbl" for="freshman_can_apply_0">신입 지원 가능</label></span>
											</div>
											<!-- 오류 시 텍스트 -->
											<em class="msgInvalid" id="cyr_msg" >
									...
									<div class="items">
										...
										<div class="area_data etc_items">
											<div class="TypoBox">
												<input type="text" class="Typo SizeL" id="rcrtCondition" value="${recruit.rcrtCondition}"
				...
				<div class="frm_body frm_condition">
					...
					<div class="items" id="salary">
						...
						<div class="items" id="job_type">
							...
							<!-- 						출퇴근시간 -->
							<div class="items options" id="workTimeArea"
								style="display: block;">
								<div class="area_tit">
									<em class="required"></em> <strong class="tit">출퇴근 시간</strong>
								</div>
								<div class="area_data">
				...
				<div class="frm_header">
					...
					<div class="items" id="applyPeriod">
						...
						<div class="area_data">
							...
							<div class="row apply_datetime pl-3">
								<div class="TypoBox">
								...
								<div class="row">
									<ul class="job_list_check" id="job_type_list">
										<li>
											<div class="InpBox">
												<span class="Chk SizeL"> <input type="radio"
													name="rcrtRectype" id="job_type_13" value="내일을jOB자"
													data-help_target="job_type"><label
										...
										<li>
											<div class="InpBox">
												<span class="Chk SizeL"> <input type="radio"
													name="rcrtRectype" id="job_type_14" value="홈페이지접수"
													data-help_target="job_type"><label
							...
							<div class="area_data">
								...
								<div class="items" id="applyPeriod">
									...
									<div class="area_data">
										...
										<div class="row apply_datetime mt-2 ml-1">
											<div class="TypoBox mr-0">
												<input type="date" id="rprocSdate" name="rProcedure[0].rprocSdate"
													class="Typo DatePic SizeL type_calendar"
													aria-label="전형 시작일" style="cursor: pointer;"
													autocomplete="off">
											</div>

											<div class="TypoBox ml-2">
												<input type="date" id="rprocEdate"  name="rProcedure[0].rprocEdate"
													class="Typo DatePic SizeL type_calendar"
													aria-label="전형 마감일" style="cursor: pointer;"
													autocomplete="off">
											</div>
											<input type="hidden" name="rProcedure[0].rprocTypeno" value="RE01" />
											<input type="hidden" name="rProcedure[0].rprocOrder" class="clsRprocOrder" value="1">
										</div>
									</div>
									<em class="msgInvalid" id="cyr_msg" >
										<form:errors path="rProcedure[0].rprocTypeno" element="span" id ="password1_warning_txt" cssClass="errors"   class="alert_column good_txt"></form:errors><br>
										<form:errors path="rProcedure[0].rprocOrder" element="span" id ="password1_warning_txt" cssClass="errors"   class="alert_column good_txt"></form:errors><br>
									</em>
								</div>
							</div>
						</div>
							...
							<div class="area_data">
								<ul class="list_checkbox">
									<div class="items" id="applyForm">
										<div class="area_data" >
											<!-- 사람인 이력서 & 자유양식 선택 -->
										<div  id="proadd" class="proaddStyle">
										
										</div>
											<button type="button" id="proAddBtn"
												class="BtnType SizeM GrayBg btn_add_field btn_recruit_frm ga_data_layer proAddBtnStyle"
					...
					<div class="frm_body frm_manager">
						<div class="items" id="manager_nm_area">
							...
							<div class="area_data">
								<span class="manager_name">
									<div class="TypoBox">
										<input type="text" id="rcrtNm" name="rcrtNm" value="${recruit.rcrtNm}"
						...
						<div class="items" id="manager_tel_area">
							...
							<div class="area_data">
								<span class="manager_name">
									<div class="TypoBox">
										<input type="text" id="rcrtTel" name="rcrtTel" value="${recruit.rcrtTel}"
											class="Typo SizeL " aria-label="연락처 입력"
											placeholder="연락처 입력해주세요" maxlength="30">
									</div>
								</span>
								<div class="MsgTxt Invalid _invalid_msg" id="address_lating_msg">
									<!-- 오류 시 텍스트 -->
						...
						<div class="items" id="manager_email_area">
							...
							<div class="area_data">
								<div class="manager_email">
									<div class="TypoBox">
										<input type="text" id="rcrtMail" name="rcrtMail" class="Typo SizeL" value="${recruit.rcrtMail}"
						...
						<div class="items" id="manager_email_area">
							...
							<div class="area_data">
								<div class="manager_email">
									<div class="TypoBox">
										<input type="text" id="rcrtWlfr" name="rcrtWlfr" class="Typo SizeL" value="${recruit.rcrtWlfr}"
						...
						<div class="wrap_bottom_btn">
							...
							<c:set value="<%=session.getAttribute(\"authDivision\") %>" var="company" />
							<c:if test="${ company eq 'H03'}">
...
$(function(){
	...
	$('#testAutoInsert').on("click",function(){
      ...
      $("#title").val("2023년 태영건설 인사팀 신입사원 모집"); //공고제목
//       $("#tjobCode").val("5"); //상위 직업
//       $("#jobCode").val("인사"); //하위 직업
      $("#rcrtField").val("인사"); //모집분야명
      $("#rcrtPerson").val("3"); //모집인원
      $("input:checkbox[name='rcrtCareer'][value='신입']").prop("checked", true);
      $("#rcrtCondition").val("인사 자격증 우대"); 
      $("#edu_select").val("고등학교졸업이상"); 
//       $("#rcrtLoc").val("대전 동구 대전로 387"); 
      $("input:checkbox[name='rcrtType'][value='정규직']").prop("checked", true);
      $("#rcrtSalary").val("연봉"); 
      $("#salary_ipt").val("3,300"); 
      $("input:radio[name='rcrtWeek'][value='유연근무제']").prop("checked", true);
      $("#work_shift_time_start").val("08:00");
      $("#work_shift_time_end").val("18:00");
      $("#start_date").val("2023-12-14");
      $("#end_date").val("2023-12-15");
      $("input:radio[name='rcrtRectype'][value='내일을jOB자']").prop("checked", true);
      $("#rprocSdate").val("2023-12-14");
      $("#rprocEdate").val("2023-12-15");
      $("#rcrtNm").val("김소원");
      $("#rcrtTel").val("010-1234-1234");
      $("#rcrtMail").val("taeyoung@naver.com");
      $("#rcrtWlfr").val("슬기로운 육아휴직, 대출부터 사택까지! 주거 관련 복리후생 우수 기업");
...
//----------------------------------------------------------------------------------
	...
	$("#proAddBtn").on('click',function(){
		  ...
		  let makeTrTag =function(dataList){
			  let trTags=`
					...
					<div class="items aa aaStyle" id="applyPeriod">
					<input type"text" value="\${orderCounter}차" class="clsCha clsChaStyle" readonly>
			...
			<div class="InpBox SizeL form_type ga_data_layer formTypeStyle"
						data-ga_data_layer="ga_lead|pc_rec_hiring_process|btn_application"
						id="af_select_form">
				<select  name="rProcedure[\${orderCounter-1}].rprocTypeno" style="width:300px;" id="proSelect" class="proSelectStyle mr-1" onchange="SW_test(this)">
					<option>선택<option>
			...
			<select name="rProcedure[\${orderCounter-1}].testNo" id="testSelect" style="display: none; width:400px;" >
			<option>선택<option>
			`;
			  ...
			  trTags += `</select>
			   <input type="hidden" name="rProcedure[\${orderCounter-1}].rprocOrder" class="clsRprocOrder" value="\${orderCounter}">
			 </div>
			    
				<button type="button" data-cnt="`+orderCounter+`"
					class="BtnType SizeM GrayBg btn_add_field btn_recruit_frm ga_data_layer proDelBtn proDelBtnStyle"
					data-ga_data_layer="ga_lead|pc_rec_division|btn_add">
					삭제</button>
			 </span>
			  `;
	...
	$(document).on("click",".proDelBtn", function (event) {
        ...
        $(".clsCha").each(function(idx){
        	$(this).val((idx+2) + "차"); // 보여지는 read only 로한 차수 보여지기 위한
        });
            
        $(".clsRprocOrder").each(function(idx){ //디비에 저장해야하는 인덱스 0부터 시작이니까 +1
        	$(this).val(idx+1);
